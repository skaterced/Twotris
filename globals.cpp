...
/*
class Square stillSquaresP1 [MAXS]={Square(TR1+4*SW,TL1,TYPE_SIMPLE),Square(TR1+5*SW,TL1,TYPE_SIMPLE),Square(TR1+9*SW,TL1,TYPE_4),Square(TR1+10*SW,TL1,TYPE_4),Square(TR1+15*SW,TL1,TYPE_DOTS),Square(TR1+16*SW,TL1,TYPE_DOTS),Square(TR1+14*SW,TL1,TYPE_DOTS),
